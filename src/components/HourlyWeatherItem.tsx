...
const HourlyWeatherItem = () => {
  return (
    <div className="flex flex-col items-center justify-center w-card px-12 py-8">
      <span className="text-weather-grey text-sm font-normal mb-8">11:00</span>
      <svg
      ...
      <span className="text-bold text-base text-white deg">10</span>
    </div>
  );
};
